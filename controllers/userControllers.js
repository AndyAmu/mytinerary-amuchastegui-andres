    ...
    const UserControllers = {
        ...
        verifyEmail: async (req, res) => {
            ...
            if (user) {
                ...
                await user.save()
            res.redirect("https://my-tinerary-and-amu.herokuapp.com") 
